...
def main():
    ...
    for instance_num in range(5):
        ...
        save_text_file_path = "/home/scatha/research_ws/src/lifelong_object_learning/data/captured_cropped/" + object_class + "/" + object_class + "_" + object_instance + "/metadata/"
        save_image_path = "/home/scatha/research_ws/src/lifelong_object_learning/data/captured_cropped/" + object_class + "/" + object_class + "_" + object_instance + "/images/"
